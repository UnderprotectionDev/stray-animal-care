              ...
              fields: [
                ...
                },
                {
                  ...
                  fields: [
                    ...
                    t('bankInfo', 'Banka Bilgileri', 'Banka Bilgileri'),
                    t('contactUs', 'İletişim', 'İletişim'),
                    t('quickLinks', 'Hızlı Bağlantılar', 'Hızlı Bağlantılar'),
                    t('international', 'Uluslararası', 'Uluslararası Destek'),
                    t('copyIban', 'IBAN Kopyala', 'IBAN\'ı Kopyala'),
