...
export function VolunteerTimeline({ steps }: Props) {
  ...
  return (
    <div ref={containerRef} className="panel px-6 py-8 lg:px-8 lg:py-10">
      ...
      <div className="relative">
        ...
        <div
          ref={lineRef}
          className="hidden md:block absolute top-[3.5rem] left-[10%] right-[10%] h-[1.5px] bg-trust origin-left"
          style={{ transformOrigin: 'left center' }}
          aria-hidden="true"
        />

        <div className="grid gap-6 md:grid-cols-3 md:gap-[1.5px] md:bg-border">
          {steps.map((step, i) => (
            <div
              key={i}
              data-step-card
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <span
                  ...
                  style={{
                    WebkitTextStroke: '1.5px var(--trust)',
                    color: 'transparent',
                  }}
                >
                  {step.number}
                ...
                {/* Step dot (desktop) */}
                <div
                  className="hidden md:block w-4 h-4 border-[1.5px] border-trust bg-trust"
                  aria-hidden="true"
                />
              </div>
              ...
              {i < steps.length - 1 && (
                <div className="md:hidden flex justify-center py-2" aria-hidden="true">
                  <div className="w-[1.5px] h-8 bg-trust" />
                </div>
              )}

              {/* Accent bottom bar */}
              <div
                className="absolute bottom-0 left-0 right-0 h-1 bg-trust"
