          ...
          <MagneticTilt maxRotation={4}>
            <MovingBorder color="var(--background)" speed={3}>
              <WhatsAppButton
                ...
                className="!bg-background !text-foreground !rounded-none px-8 py-4 font-bold uppercase text-sm tracking-wider"
              >
                {buttonLabel}
              </WhatsAppButton>
            </MovingBorder>
